...
*   **Описание**: Возвращает данные PSI/SI канала.
*   **Реализация**: Использует объект из `ChannelStorage` для получения PSI данных.
*   **JSON-ответ**:
    ```json
    {
      "name": "Discovery",
...
*   **Описание**: Возвращает таблицу PSI для адаптера.
