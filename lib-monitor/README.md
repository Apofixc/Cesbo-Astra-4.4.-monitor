...
### Система фильтрации
При создании подписки можно указать сложные условия:
*   **Операторы**: `{ "conditions": [{ "field": "total.bitrate", "op": "lt", "value": 1000 }] }`
*   **Lua-скрипты**: `{ "script": "return data.cc_errors > 0" }`
