...
*   **Система подписок (Event Dispatcher)**: Унифицированная шина событий с поддержкой приоритетов, очередей и асинхронной обработки.
*   **Гибкая фильтрация и троттлинг**: Возможность фильтрации событий по условиям (операторы, Lua-скрипты) и ограничение частоты отправки.
...
*   **Оптимизация производительности**:
    ...
    *   **Предкомпиляция масок (Wildcards)**: Маски событий компилируются в оптимизированные функции сопоставления при создании подписки.
...
*   **Маски (Wildcards)**: Подписка на `channel:*` или `adapter:*`.
