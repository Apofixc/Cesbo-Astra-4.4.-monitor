...
*   **Мониторинг системных ресурсов**: Детальный сбор метрик процесса Astra (CPU User/System, RAM RSS/Virtual, Threads, Uptime) и получение списка сетевых интерфейсов. Использует прецизионный расчет CPU на основе `os.clock()` и оптимизированный парсинг `/proc` с ранним выходом. Поддерживает сглаживание показателей через Moving Average.
