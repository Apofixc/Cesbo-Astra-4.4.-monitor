...
-- ===========================================================================
-- Модуль `http.http_server`
--
-- Отвечает за инициализацию и запуск HTTP-сервера, который предоставляет
-- REST API для управления и мониторинга DVB-тюнеров, каналов и системных ресурсов.
-- ===========================================================================
